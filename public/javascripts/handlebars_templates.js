...
this["JST"]["cart_item"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- <figure><img src=img /></figure><p>quantity x $price</p> -->";
},"useData":true});
...
this["JST"]["cart"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<ul>"
    ...
    + "</ul><section><h3>Your shopping cart</h3><p class=\"total\">"
    ...
    + "</p><p></p><footer><a href=\"#\" class=\"left empty_cart\" id=\"empty\">Empty Cart</a><a href=\"/checkout\" class=\"right checkout\" id=\"checkout\">Checkout</a></footer></section>";
},"useData":true});
...
this["JST"]["checkout"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"img_top\"></div><section><h1>Order Details</h1><table><thead><tr><th>Item</th><th></th><th>Quantity</th><th>Price</th></tr></thead><tbody>"
    ...
    + container.escapeExpression((helpers.format_price || (depth0 && depth0.format_price) || helpers.helperMissing).call(alias1,(depth0 != null ? depth0.total : depth0),{"name":"format_price","hash":{},"data":data}))
    + "</span></p><footer><a href=\"#\" id=\"cancel\">Cancel order</a><form action=\"/\" method=\"post\"><input type=\"submit\" value=\"ORDER NOW!\"></form></footer></section><div class=\"img_bottom\"></div>";
},"useData":true});

this["JST"]["header"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;

  return "<a class=\"logo\"><img src=\"images/logo.png\"></a><div class=\"cart\"><a href=\"/\"><span class=\"left\">Shopping Cart</span><span class=\"right\"><!----><span class=\"count\">"
